...
Route::get('/allgames',[GameController::class,'recupgames'])->middleware(['auth', 'verified'])->name('recupgames');
...
Route::get("/category/{id}",[GameController::class,'recupCategory'])->name('category_page');
